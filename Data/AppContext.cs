...
namespace AgendaApi.Data
{
    public class AppContext
    {
        ...
        public AppContext(DbContextOptions<StudentsQuestionsContext> options) : base(options) //Acá estamos llamando al constructor de DbContext que es el que acepta las opciones
        {
